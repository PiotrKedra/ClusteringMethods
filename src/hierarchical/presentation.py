...
from src.hierarchical.hierarchical_linkage import hierarchical_linkage
...
y_hc = hierarchical_linkage(data, n_clusters=2, linkage='single')
...
y_hc = hierarchical_linkage(data, n_clusters=2, linkage='complete')
