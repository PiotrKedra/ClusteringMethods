...
def update_e_value_matrix(e_value_matrix, single_e_values, clusters, cluster_to_merge_1, cluster_to_merge_2):
    index_to_update = 0
...
def ward(df, n_clusters=5):
    ...
    matrix = np.delete(e_value_pair_matrix, n, 0)
    matrix = np.delete(e_value_pair_matrix, n, 1)
    """
    while n_clusters != len(clusters):
        ...
        # print(min_e_value)
        # print(cluster_to_merge_1)
        # print(cluster_to_merge_2)
        ...
        e_value_matrix = update_e_value_matrix(e_value_matrix, single_e_values, clusters, cluster_to_merge_1, cluster_to_merge_2)
...
clusters = ward(data, n_clusters=2)
